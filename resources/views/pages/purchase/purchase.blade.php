...
<div class="container">
  <div class="card m-0">
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Purchase Invoice<img class='buffer float-right d-none' src="{{asset('storage/admin-lte/dist/img/buffer.gif')}}" alt=""></h5>
     </div>
      ...
      <div class="row">
        <div class="col-12 col-md-3"> 
          <div class="form-group">
            ...
            <select class="form-control" id="supplier" onchange="getBlnce(this.value)">
            </select>
