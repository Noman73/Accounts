...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Buyer List<img class="float-right buffer img-buffer d-none" src="{{asset('storage/admin-lte/dist/img/buffer.gif')}}" alt=""></h5>
     </div>
    ...
    let html='';
      ...
      for (var i = 0; i < data.length; i++){
        html+=`<tr style='height:12px;'>
                ...
                <td>`+data[i]['adress']+`</td>
                <td>`+data[i]['phone1']+`</td>
                <td>`+(data[i]['stutus']==1 ? 'Active': 'Deactive')+`</td>
               </tr>`
      }
       html+="</tbody>"
      header=`<h6 style='text-align:center;margin-top:10px;'>Buyer List</h6>
