        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">client/customer</li>
...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Manage Customer</h5>
     </div>
        ...
        <!-- Modal -->  
              ...
              <div class="modal-body" id="forms">
               ...
               <div class="input-group mt-4">
                 <label class="control-label col-sm-2 text-lg-right" for="name">Company Name :</label>
                 <div class="col-sm-10">
               ...
               <div class="input-group">
                 <label class="control-label col-sm-2 text-lg-right" for="name">Customer/Client Name:</label>
                 <div class="col-sm-10">
               ...
               <div class="input-group">
                 <label class="control-label col-sm-2 text-lg-right" for="phone1">Phone 1 :</label>
                 <div class="col-sm-10">
               ...
               <div class="input-group">
                 <label class="control-label col-sm-2 text-lg-right" for="phone2">Phone 2 :</label>
                 <div class="col-sm-10">
               ...
               <div class="input-group">
                 <label class="control-label col-sm-2 text-lg-right" for="name">Email :</label>
                 <div class="col-sm-10">
               ...
               <div class="input-group">
                 <label class="control-label col-sm-2 text-lg-right" for="birthDate">Birth Date :</label>
                 <div class="col-sm-10">
               ...
               <div class="input-group">
                 <label class="control-label col-sm-2 text-lg-right" for="mariageDate">Mariage Date :</label>
                 <div class="col-sm-10">
               ...
               <div class="input-group">
                 <label class="control-label col-sm-2 text-lg-right" for="adress">Adress:</label>
                 <div class="col-sm-10">
               ...
               <div class="input-group">
                 <label class="control-label col-sm-2 text-lg-right" for="city">City :</label>
                 <div class="col-sm-10">
               ...
               <div class="input-group">
                 <label class="control-label col-sm-2 text-lg-right" for="postalCode">Postal Code :</label>
                 <div class="col-sm-10">
               ...
               <div class="input-group">
                 <label class="control-label col-sm-2 text-lg-right" for="stutus">Stutus :</label>
                 <div class="col-sm-10">
               ...
               <div class="input-group">
                 <label class="control-label col-sm-2 text-lg-right" for="group">Group :</label>
                 <div class="col-sm-10">
                   <select  class="form-control form-control-sm" id="group_type">
                     <option value="">--SELECT--</option>
                     <option value="Regular">Regular</option>
                     <option value="Walking">Walking</option>
                   </select>
                   <div id="group_type_msg" class="invalid-feedback">
                   </div>
                 </div>
               </div>
               </form>
...
function ajaxRequest(){
  ...
  .then(function (response){
    ...
    if (response.data.message=='success') {
      window.toastr.success('Client Added Success');
