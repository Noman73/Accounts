...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Installment Pay</h5>
     </div>
    <div class="card-body px-3 px-md-5">
      <form id="myForm">
        <div class="input-group">
           <label class="control-label col-sm-2 col-md-2 text-lg-right" for="type">Customer:</label>
        ...
        <div class="input-group">
           <label class="control-label col-sm-2 text-lg-right" for="type">Date:</label>
           <div class="col-sm-9">
        ...
        <div class="input-group">
           <label class="control-label col-sm-2 text-lg-right" for="bank">Bank:</label>
           <div class="col-sm-9">
        ...
        <div class="input-group">
           <label class="control-label col-sm-2 text-lg-right" for="type">Transaction:</label>
           <div class="col-sm-9">
        ...
        <div class="input-group">
           <label class="control-label col-sm-2 text-lg-right" for="type">Ammount $:</label>
           <div class="col-sm-9">
              <input disabled="" class="form-control form-control-sm" name="ammount" id="ammount" placeholder="Enter Ammount .....">
        ...
        <div class="col-md-2" id="submit">
          <button class="btn btn-sm btn-secondary" onclick="Reset()">Reset</button>
          <button class="btn btn-sm btn-primary submit" onclick="Request()">Submit</button>
        </div>
            </div>
  </div>
</div>
...
<script>
 ...
 function getInvoice(){
  ...
  if (id!='') {
      ...
      .then((res)=>{
        console.log(res.data[0].total_paid,res.data[0].total_days)
