...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Sales Return</h5>
     </div>
      ...
      <div class="row">
        <div class="col-12 col-md-6"> 
          <div class="form-group">
            ...
            <span class="d-none p-1" id="balance"></span>
          </div>
        </div>
        <div class="col-12 col-md-6">
...
function totalCalculation(){
  ...
  discount=parseFloat($('#fine').val());
  if (!isNaN(total_payable)) {
    if (isNaN(discount)) {
      discount=0;
    }
    total_payableX=(total_payable*discount)/100;
    $('#total_payable').val(total_payable-total_payableX);
  }
}
...
if (isValid==true) {
   ...
   total=$('#final_total').val();
    ...
    axios.post('admin/invoice_back',formData)
    .then(function(response){
      console.log(response.data);
