...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Database Backup</h5>
     </div>
    <div class="card-body px-3 px-md-5">
      <button class="btn-lg btn-danger backup">Create New Backup</button><img class="d-none" src="{{asset('storage/admin-lte/dist/img/buffer.gif')}}" alt="" id="buffer">
