...
<div class="container">
    ...
    <div class="card-header pt-3  flex-row align-items-center justify-content-between">
      <h5 class="m-0 font-weight-bold">Manage User</h5>
     </div>
              ...
              <div class="modal-body">
                <form id="myForm">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-sm" id="name"  type="text" placeholder="Enter Users Name...">
                    <div id="category_msg" class="invalid-feedback">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="font-weight-bold">Email:</label>
                    <input class="form-control form-control-sm" id="name"  type="email" placeholder="Enter User Email...">
                    <div id="category_msg" class="invalid-feedback">
                    </div>
                  </div>
                </form>
...
function ajaxRequest(){
  $('.submit').addClass('disabled').attr('disabled',true);
    ...
    //axios post request
    if (!id) {
        axios.post('/admin/manage_role',formData)
        .then(function (response){
