              ...
              <div class="modal-body">
                <form id="myForm">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-sm" id="name"  type="text" placeholder="Enter Permission Name...">
...
<script type="text/javascript">
   $.ajaxSetup({
    ...
    $('.data-table').DataTable({
        ...
        serverSide:true,
        ajax:{
          url:"{{ URL::to('/admin/manage_permission') }}"
        },
        columns:[
          {
            data:'DT_RowIndex',
...
function ajaxRequest(){
  $('.submit').addClass('disabled').attr('disabled',true);
    ...
    //axios post request
    if (!id) {
        axios.post('/admin/manage_permission',formData)
        .then(function (response){
